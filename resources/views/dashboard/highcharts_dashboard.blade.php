...
<h3 class="" <div class="separator-breadcrumb border-top">
    </div>
    <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select class="facilities form-control selectpicker" id="facilities" name="facilities[]"
                            multiple data-live-search="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form role="form" method="post" action="{{route('changepass')}}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="confirm_new_password" class="col-sm-2 control-label">Confirm
                                            Password
                                        </label>
                                        <div class="col-sm-10">
                                            <input type="password" pattern=".{6,20}" required
