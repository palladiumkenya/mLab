            ...
            <div class="card-body">
                ...
                <form role="form" method="post" action="{{route('addilfacility')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            <label for="phone">Internet Enabled?</label>
                            <select class="form-control" id="internet" data-width="100%" name="internet">
                                <option>Select Internet Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>

                        <div id="phoneInput" hidden class="col-md-6 form-group mb-3">
...
<script type="text/javascript">
    ...
    $('#internet').change(function() {
        ...
        if (internet == 'No') {
            $('#phoneInput').removeAttr('hidden');
        } else {
            $("#phoneInput").attr("hidden", true);
        }
    })
</script>
