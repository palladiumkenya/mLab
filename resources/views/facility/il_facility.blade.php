                    ...
                    <div class="card text-left">
                        ...
                        <div class="card-body">
                            ...
                            <div style="margin-bottom:10px; ">
                                <a type="button" href="{{route('addilfacilityform')}}" class="btn btn-primary btn-md pull-right">Add IL Facility</a>
                            </div>                            
                                                ...
                                                @foreach($facilities as $facility)
                                                    <tr> 
                                                        ...
                                                        <td>
                                                            ...
                                                            <button onclick="deleteFacility({{$facility->mfl_code}});"type="button" class="btn btn-danger btn-sm">Delete</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
