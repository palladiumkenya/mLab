                    ...
                    <div class="card text-left">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12" style="margin-top:10px; ">
                                <?php echo e($results->appends(request()->input())->links()); ?>
                                            ...
                                            <?php if(count($results) > 0): ?>
                                                <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr> 
                                                        ...
                                                        <td>  <?php echo e($result->result_type); ?></td>
                                                        <td> <?php if(!empty($result->client_id)): ?> <?php echo e($result->client_id); ?> <?php else: ?> Not Provided <?php endif; ?></td>
                                                        <td>  <?php echo e($result->age); ?></td>
                                                        <td>  <?php echo e($result->gender); ?></td>
                                                        <td>  <?php echo e($result->result_content); ?> <?php echo e($result->units); ?></td>
                                                        <td>  <?php echo e($result->data_key); ?></td>
                                                        <td>  <?php echo e($result->date_collected); ?></td>
