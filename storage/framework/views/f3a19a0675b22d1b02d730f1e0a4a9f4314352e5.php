    <div class="main-header">
            ...
            <div class="menu-toggle">
                <a href="<?php echo e(route('home')); ?>"><i class="i-Home"></i><h1 style="color:blue;">mLab</h1></a>
            </div>
            ...
            <div class="d-flex align-items-center">
                        ...
                        <?php if(Auth::user()->user_level < 2): ?>
                            ...
                            <div class="col-md-6 p-4">
                                ...
                                <div class="menu-icon-grid w-auto p-0">
                                    ...
                                    <a href="<?php echo e(route('hts_results')); ?>"><i class="i-Neutron"></i> HTS Results</a>
                ...
                <div >
                <p></p>
                   <h6> Welcome, <b><?php echo e(ucwords(Auth::user()->f_name)); ?> <?php echo e(ucwords(Auth::user()->l_name)); ?></b>: <?php if(Auth::user()->user_level < 2): ?>   National Dashboard 
                   <?php elseif(Auth::user()->user_level == 2): ?> <?php echo e(Auth::user()->partner->name); ?> Dashboard
                   <?php elseif(Auth::user()->user_level == 3): ?> <?php echo e(Auth::user()->facility->name); ?> Dashboard <b>(MFL: <?php echo e(Auth::user()->facility->code); ?>)</b>
                   <?php elseif(Auth::user()->user_level == 4): ?> <?php echo e(Auth::user()->facility->name); ?> Dashboard <b>(MFL: <?php echo e(Auth::user()->facility->code); ?>)</b>
            ...
            <div class="header-part-right">
                ...
                <div class="dropdown">
                    <div  class="user col align-self-end">
                        <img src="<?php echo e(asset('assets/images/faces/face.png')); ?>" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                            <div class="dropdown-header">
                                <i class="i-Lock-User mr-1"></i> <b><?php echo e(ucwords(Auth::user()->f_name)); ?> <?php echo e(ucwords(Auth::user()->l_name)); ?></b>
                            </div>
                            <a class="dropdown-item"><?php if(Auth::user()->user_level < 2): ?>   National
                   <?php elseif(Auth::user()->user_level == 2): ?> <?php echo e(Auth::user()->partner->name); ?>
