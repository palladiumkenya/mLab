                ...
                <table id="multicolumn_ordering_table" class="display table table-striped table-bordered"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Email</th>
                            <th>Level</th>
                            <?php if(Auth::user()->user_level < 2): ?> <th>Affiliation</th>
                                <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if(Auth::user()->user_level < 2): ?> <td> <?php if(!empty($user->partner)): ?>
                                <?php echo e($user->partner->name); ?><?php elseif(!empty($user->facility->sub_county->county)): ?>
                                <?php echo e($user->facility->sub_county->county->name); ?> County <?php else: ?> None <?php endif; ?>
                                <?php endif; ?>
                                <?php if(Auth::user()->user_level == 2): ?>
                                <td> <?php if(!empty($user->facility)): ?><?php echo e($user->facility->name); ?><?php else: ?> None <?php endif; ?> </td>
                                <?php endif; ?>
                                ...
                                <td>
                                    <button onclick="editUser(<?php echo e($user); ?>);" data-toggle="modal" data-target="#editUser"
                                        type="button" class="btn btn-primary btn-sm">Edit</button>
                                    <button onclick="resetUser(<?php echo e($user->id); ?>);" type="button"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select id="level" name="level" class="form-control">
                                            ...
                                            <?php if(Auth::user()->user_level < 2): ?> <option value="1">National</option>
                                    ...
                                    <?php if(Auth::user()->user_level < 2): ?> <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select hidden class="form-control" data-width="100%" id="county"
                                            ...
                                            <?php if(count($counties) > 0): ?>
                                            <?php $__currentLoopData = $counties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $county): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($county->id); ?>"><?php echo e(ucwords($county->name)); ?> County
                                            </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
