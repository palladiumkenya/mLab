    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                let userlevel = '<?php echo Auth::user()->user_level; ?>';
                if (userlevel == 2) {
                    let partnerId = '<?php echo Auth::user()->partner_id; ?>';
        ...
        $('#dataFilter').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('filterDashboard')); ?>",
                success: function(data) {
        ...
        $(document).ready(function() {
            ...
            $("#partners").change(function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('get_dashboard_counties')); ?>",
                    success: function(data) {
                        $('#counties').empty();
            ...
            $("#counties").change(function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('get_dashboard_sub_counties')); ?>",
                    success: function(data) {
                        $('#subcounties').empty();
            ...
            $("#subcounties").change(function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('get_dashboard_facilities')); ?>",
                    success: function(data) {
                        $('#facilities').empty();
